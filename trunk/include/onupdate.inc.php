 ...
 */
/*
function impolling_db_upgrade_1() {
}
function impolling_db_upgrade_2() {
}
*/

function icms_module_update_impolling($module) {
    return TRUE;
}

function icms_module_install_impolling($module) {
	return TRUE;
}